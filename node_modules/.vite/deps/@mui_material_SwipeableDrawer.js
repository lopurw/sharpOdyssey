...
} from "./chunk-2XIVYWKJ.js";
import {
  FocusTrap,
  useModal
} from "./chunk-QE57ERYO.js";
import "./chunk-VL7VRILL.js";
import "./chunk-5AD5PNO4.js";
import "./chunk-4YBK4WH6.js";
...
import {
  ...
  useRootElementName,
  useSlotProps
} from "./chunk-RC6U5B3E.js";
import {
  getTransitionProps
} from "./chunk-TJ4WWSAQ.js";
import {
  useTheme
} from "./chunk-2Y3XS7XV.js";
import {
  useEventCallback_default as useEventCallback_default2
} from "./chunk-WRYWWXYI.js";
import {
  useForkRef_default
} from "./chunk-2BCP2MLW.js";
import {
  HTMLElementType,
  chainPropTypes,
  debounce,
...
} from "./chunk-6VZJ7NOI.js";
import {
  capitalize_default
} from "./chunk-FBCURFME.js";
import {
  rootShouldForwardProp,
  styled_default
} from "./chunk-MA5YEHAR.js";
import "./chunk-XH6KMXX4.js";
import {
...
var _excluded26 = ["anchor", "classes", "className", "width", "style"];
...
var SwipeArea = React68.forwardRef(function SwipeArea2(props, ref) {
  ...
  const ownerState = props;
  return (0, import_jsx_runtime44.jsx)(SwipeAreaRoot, _extends({
...
true ? SwipeArea.propTypes = {
   ...
   */
  anchor: import_prop_types28.default.oneOf(["left", "top", "right", "bottom"]).isRequired,
  /**
   * @ignore
   */
...
var _excluded28 = ["anchor", "disableBackdropTransition", "disableDiscovery", "disableSwipeToOpen", "hideBackdrop", "hysteresis", "allowSwipeInChildren", "minFlingVelocity", "ModalProps", "onClose", "onOpen", "open", "PaperProps", "SwipeAreaProps", "swipeAreaWidth", "transitionDuration", "variant"];
...
var SwipeableDrawer = React69.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded27), other = _objectWithoutPropertiesLoose(props, _excluded28);
  ...
  return (0, import_jsx_runtime46.jsxs)(React69.Fragment, {
    children: [(0, import_jsx_runtime45.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime45.jsx)(NoSsr, {
      children: (0, import_jsx_runtime45.jsx)(SwipeArea_default, _extends({
        anchor,
        ref: swipeAreaRef,
...
true ? SwipeableDrawer.propTypes = {
   ...
   * @default false
   */
  allowSwipeInChildren: import_prop_types29.default.oneOfType([import_prop_types29.default.func, import_prop_types29.default.bool]),
  /**
   * @ignore
   */
   ...
   * @default false
   */
  disableBackdropTransition: import_prop_types29.default.bool,
  /**
   * If `true`, touching the screen near the edge of the drawer will not slide in the drawer a bit
   * to promote accidental discovery of the swipe gesture.
   * @default false
   */
  disableDiscovery: import_prop_types29.default.bool,
  /**
   * If `true`, swipe to open is disabled. This is useful in browsers where swiping triggers
   * navigation actions. Swipe to open is disabled on iOS browsers by default.
   * @default typeof navigator !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)
   */
  disableSwipeToOpen: import_prop_types29.default.bool,
  /**
   * @ignore
   */
   ...
   * @default 0.52
   */
  hysteresis: import_prop_types29.default.number,
  /**
   ...
   * @default 450
   */
  minFlingVelocity: import_prop_types29.default.number,
  /**
   * @ignore
   */
  ModalProps: import_prop_types29.default.shape({
    BackdropProps: import_prop_types29.default.shape({
   ...
   */
  SwipeAreaProps: import_prop_types29.default.object,
  /**
   * The width of the left most (or right most) area in `px` that
   * the drawer can be swiped open from.
   * @default 20
   */
  swipeAreaWidth: import_prop_types29.default.number,
  /**
