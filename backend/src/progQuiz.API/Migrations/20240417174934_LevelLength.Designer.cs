...
namespace progQuiz.API.Migrations
{
    ...
    [Migration("20240417174934_LevelLength")]
    partial class LevelLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("progQuiz.API.Models.Level", b =>
                {
            ...
            modelBuilder.Entity("progQuiz.API.Models.LevelResult", b =>
                {
            ...
            modelBuilder.Entity("progQuiz.API.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("progQuiz.API.Models.LevelResult", b =>
                {
                    b.HasOne("progQuiz.API.Models.Level", "Level")
                        .WithMany("LevelResults")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("progQuiz.API.Models.User", "User")
                        .WithMany("LevelResults")
